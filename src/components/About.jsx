  ...
  return (
    <>
      <div ref={page2} className=" w-full">
        <p
          className=" text-2xl font-semibold mt-9 text-center mb-[-40px]"
          ref={aboutRef}
          ...
          <div className="flex flex-col">
            <div className=" page2 space-y-2">
              <p ref={text2} className="text-1xl md:text-md text-justify ">
                I'm Sudarshan Patil, a Frontend Developer based in Pune with 2+
                years of experience building fast, responsive web applications
                with React.js. I care about clean component architecture, smooth
                user experiences, and writing code that's easy to maintain. When
                I'm not working on production features, I'm building side
                projects — a trading dashboard, client websites, and whatever
                else keeps me learning.
              </p>
              <br />
              {/* Social media icons */}
              <div className="space-y-2 flex flex-col items-center justify-center">
                <h1 ref={text3} className="text-1xl font-medium ">
            ...
            <hr className="w-full" />
            <p
              className=" text-2xl font-semibold mt-9 mb-4 text-center }"
            ...
            <br />
            <br />
            <p className="text-2xl font-semibold mt-12 mb-4 text-center">
              Education
            </p>
            <br />
            <div className=" border-b-2 mt-9">
            ...
            <div className=" border-b-2 mt-9">
              <div className="flex justify-between">
                <h1 className="text-md md:text-xl text-[#666666]">
                  G.T.Patil Arts,Commerce & Science College
                </h1>
                <span className="text-[0.7rem]  md:text-sm   rounded-full bg-[#D7FFE0] text-[#018C0F] text-center p-1">
                  Full Time
                </span>
            ...
            <div className=" border-b-2 mt-9">
              <div className="flex justify-between">
                <h1 className="text-md md:text-xl text-[#666666]">
                  Smt. Hiriben Govinddas Shroff High School
                </h1>
                <span className="text-[0.7rem]  md:text-sm   rounded-full bg-[#D7FFE0] text-[#018C0F] text-center p-1">
                  Full Time
                </span>
