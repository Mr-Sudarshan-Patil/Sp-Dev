  ...
  const cardItems = [
    {
      id: 1,
      img: Nr,
      title: "Nirmalram Construction",
      Dec: "Developed a website for Nirmalram Construction to showcase their completed projects and highlight their construction expertise.",
      Tech: (
        <>
          &nbsp;
          <FaReact /> React, &nbsp;&nbsp;
      ...
      live: "https://nirmalram-construction.vercel.app/",
      view: "",
      isViewLink: false,
    },
    {
              ...
              <div className="w-full h-auto bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                ...
                <div className="flex flex-col justify-between p-5 h-[270px]">
                  <div>
                    ...
                    <p className="mb-3 text-xs md:text-sm text-gray-700 dark:text-gray-400 overflow-hidden text-ellipsis">
                      {Dec}
                    </p>
                    <p className="mb-3 text-sm text-gray-700 dark:text-gray-400 font-semibold flex justify-center items-center flex-wrap">
                      Tech Stack: {Tech}
                    </p>
                  </div>
                  <div className="flex justify-center gap-2 mt-auto flex-wrap">
                    {live && (
                      <a
                        href={live}
                        target="_blank"
                        className="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-pink-700 rounded-lg hover:bg-pink-800 focus:ring-4 focus:outline-none focus:ring-pink-300 dark:bg-pink-600 dark:hover:bg-pink-700 dark:focus:ring-pink-800 md:py-3 md:px-4"
                      >
                        Live Link
                      </a>
                    )}
                    {view && (
                      <a
                        href={view}
                        target="_blank"
                        className="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-gray-700 rounded-lg hover:bg-gray-800 focus:ring-4 focus:outline-none focus:ring-gray-300 dark:bg-gray-600 dark:hover:bg-gray-700 dark:focus:ring-gray-800 md:py-3 md:px-4"
                      >
                        View Source Code
                      </a>
                    )}
