      ...
      >
        ...
        <div className="flex flex-col md:flex-row justify-center items-center">
          <div className="md:w-1/2 mt-10 md:mt-0 space-y-2 ">
            ...
            <div
              ref={text2}
              className="flex space-x-1 text-2xl md:text-4xl flex-wrap"
            >
              <h1>Hello, I'm a</h1>
              <ReactTyped
            ...
            <p ref={text3} className="text-1xl md:text-md text-justify ">
              Greetings! I'm Sudarshan Patil, an accomplished frontend developer
              based in India. With a meticulous eye for design and expertise in
              HTML, CSS, JavaScript, Tailwind, React, NodeJs, ExpressJS and
              MongoDb, I specialize in crafting seamless and engaging user
              interfaces. Currently, I'm actively pursuing new frontend
            ...
            <div className="space-y-2">
              ...
              <div className="flex space-x-3 text-2xl">
                <ul ref={SocialRef} className="flex space-x-3 text-2xl">
                  ...
                  <li>
                    <a
                      href="https://github.com/Mr-Sudarshan-Patil"
                      target="_blank"
                    >
                  ...
                  <li>
                    <a
                      href="https://www.instagram.com/_er_sp_?igsh=dzZmajAxZ2czM3d2"
                      target="_blank"
                    >
